...
iOS-приложение, чтобы **купить или продать легковушку в Беларуси**.

Сейчас это рабочий клиент на демо-данных: поиск, карточка, избранное, чат, подача объявления. Без сайта av.by и без их бренда.
